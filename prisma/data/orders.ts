...
export const orderStatusHistorySeeds = [
  ...
  {
    id: 'status-history-ord-1002-paid',
    orderId: 'ORD-1002',
    oldStatus: OrderStatus.awaiting_payment,
    newStatus: OrderStatus.paid,
    changedByType: ActorType.system,
    changedById: null,
    comment: 'Stub gateway payment settled.',
    changedAt: new Date('2026-07-10T11:45:00.000Z')
  },
  {
  ...
  {
    id: 'status-history-ord-1005-paid',
    orderId: 'ORD-1005',
    oldStatus: OrderStatus.awaiting_payment,
    newStatus: OrderStatus.paid,
    changedByType: ActorType.system,
    changedById: null,
    comment: 'Stub gateway payment settled.',
    changedAt: new Date('2026-07-16T14:35:00.000Z')
  },
  {
  ...
  {
    id: 'status-history-ord-1007-paid',
    orderId: 'ORD-1007',
    oldStatus: OrderStatus.awaiting_payment,
    newStatus: OrderStatus.paid,
    changedByType: ActorType.system,
    changedById: null,
    comment: 'Stub gateway payment settled.',
    changedAt: new Date('2026-07-21T10:45:00.000Z')
  },
  {
