...
export class OrderEntity {
  ...
  @Column({ type: 'timestamp', precision: 3, name: 'confirmedAt', nullable: true })
  ...
  @Column({ type: 'timestamp', precision: 3, name: 'cancelledAt', nullable: true })
  ...
  @ManyToOne(() => CustomerEntity, (customer) => customer.orders, { onDelete: 'RESTRICT' })
  ...
  @OneToMany(() => OrderStatusHistoryEntity, (statusHistory) => statusHistory.order)
